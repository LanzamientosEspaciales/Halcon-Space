  ...
  fetch("../json/propulsores.json")
    ...
    .then(data => {
      ...
      for (const [id, propulsor] of Object.entries(data.propulsores)) {
        ...
        item.className = `gallery-item estado-${propulsor.estado}`;
        ...
        item.innerHTML = `
          ...
          <div class="gallery-item-overlay">
            ...
            <div class="gallery-item-desc">
              ...
              <div class="gallery-item-estado-${propulsor.estado}">
                ${propulsor.estado.charAt(0).toUpperCase() + propulsor.estado.slice(1)}
              </div>
            </div>
